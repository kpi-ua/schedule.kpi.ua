...
export const Project = () => (
  <TwoColumnsLayout>
    <article>
      ...
      <Paragraph>
        Цей сервіс створено для зручного доступу студентам, викладачам та працівникам університету
        до інформації щодо розкладу навчальних занять та сесії, а також графіку роботи викладачів.
      </Paragraph>
      <Paragraph>
        Ми прагнемо зробити процес планування навчання простішим і ефективнішим.
      </Paragraph>
      ...
      <Paragraph>
        Сервіс надає актуальні дані із системи формування розкладу із зазначенням дати останнього
        оновлення.
      </Paragraph>
      ...
      <Paragraph>
        ...
        <a href="https://github.com/kpi-ua/schedule.kpi.ua">schedule.kpi.ua</a>
      </Paragraph>
    </article>
    <PhotoWrapper>
